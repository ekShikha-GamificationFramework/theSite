...
<div class="tab">
	...
	<button class="tablinks" onclick="showData(event, 'act')">Activity-Wise</button>
	<button class="tablinks" onclick="showData(event, 'topic')">Topic-Wise</button>
	<button class="tablinks" onclick="showData(event, 'taxo')">Taxonomy-Wise</button>
</div>
...
<div class="sidenav">
	...
	<div id="msform">
		<fieldset>
			...
			<input type="button" class="action-button" value="Get Data" style="margin-bottom: -1vh; margin-top: -0.5vh" onclick="getStudentData()"/>
		</fieldset>
	</div>
</div>
